...
<div class="flex justify-center px-3 py-10 overflow-hidden">
    <div class="w-full max-w-xs">
        ...
        <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md" wire:submit='login'>
            ...
            <div class="mb-4">
                ...
                <input class="{{ inputStyle($errors->has('password')) }}" wire:model='password' id="password"
                    type="password">
                @error('password')
                    <div class="text-xs italic text-red-500">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-4">
                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" wire:model='remember' id="remember"
                type="checkbox">
                <label class="block mb-2 text-sm font-bold text-gray-700" for="remember">Remmeber me</label>
                @error('remember')
                    <div class="text-xs italic text-red-500">{{ $message }}</div>
                @enderror
            </div>
            <button type="submit"
                ...
                <div wire:loading.delay wire:target='login'>
                ...
                <div wire:loading.delay.remove wire:target='login'>Login</div>
            </button>
        </form>
    </div>
